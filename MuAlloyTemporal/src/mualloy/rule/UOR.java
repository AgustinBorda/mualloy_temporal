...
public class UOR {
  ...
  public static List<MutationData> mutate(UnaryExpr unaryExpr, ModelUnit mu, Opt opt, MInfo mi) {
...
//            String mutatedPartAsString = unaryExpr.accept(opt.getPSV(), null);
  ...
  public static List<MutationData> mutate(UnaryFormula unaryFormula, ModelUnit mu, Opt opt,
      MInfo mi) {
    List<MutationData> res = new ArrayList<>();
    if (mi.getType() == MInfo.MType.IGNORE) {
      return res;
