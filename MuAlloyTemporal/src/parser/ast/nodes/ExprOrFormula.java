...
public abstract class ExprOrFormula extends Node {
  ...
  private static final long serialVersionUID = 3637832146383221959L;
  ...
  public ExprOrFormula(Node parent) {
    super(parent);				
  }
  ...
  public static ExprOrFormula buildExpression(Node parent, Expr expr) { 
    if (expr instanceof ExprUnary) {
      ...
      //Wrap SigExpr with NOOP for POI
      UnaryExpr wrapper = new UnaryExpr(parent, expr.type(), null, UnaryExpr.UnaryOp.NOOP);
      wrapper.setSub(new SigExpr(wrapper, (Sig) expr));
      return wrapper;
      ...
      //Wrap FieldExpr with NOOP for POI
      UnaryExpr wrapper = new UnaryExpr(parent, fieldExpr.type(), null, UnaryExpr.UnaryOp.NOOP);
      wrapper.setSub(new FieldExpr(wrapper, fieldExpr));
      return wrapper;
